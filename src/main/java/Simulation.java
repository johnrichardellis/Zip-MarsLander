...
// print long strings with new lines the them.
    ...
    public static void main(String[] args) {
        ...
        Simulation simulation1 = new Simulation(new Vehicle(8000));  // fixed height of 8000
//            Simulation simulation1 = new Simulation(new Vehicle(Simulation.randomaltitude())); // random starting altitude

        // create a new BurnInputStream
//        BurnStream burnInputStream1 = new BurnInputStream(); // manually
//        BurnStream burnInputStream1 = new OnBoardComputer();  // via on-board cpu
        BurnStream burnInputStream1 = new BurnDataStream(); // via array

        // pass the new BurnInputStream to the runSimulation method
        simulation1.runSimulation(burnInputStream1);
